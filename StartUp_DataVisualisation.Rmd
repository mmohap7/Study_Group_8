...
startup_data_process$state_code_1 <- ifelse(is.na(startup_data$state_code_1), 'CA', startup_data_process$state_code_1)
```
...
startup_data_select <- startup_data %>%
  select(-zip_code, -city, -latitude, -longitude, -name, -unnamed_0, -unnamed_6, -id, -founded_at, -closed_at, -first_funding_at, -last_funding_at)
