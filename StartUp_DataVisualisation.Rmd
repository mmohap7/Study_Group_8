...
plot_time1 <- startup_data %>%
  ...
  geom_vline(aes(xintercept = 3.362449),  #check this again please 
               color = "#4aaec0", linetype = "dotted", size = 0.5) +  
  geom_vline(aes(xintercept = 2.293706),  #check this again please 
...
plot_time2 <- startup_data %>%
  ...
  geom_vline(aes(xintercept = 5.297772),  #check this again please 
               color = "#4aaec0", linetype = "dotted", size = 0.5) +  
  geom_vline(aes(xintercept = 3.408055),  #check this again please 
               color = "#ff5828", linetype = "dotted", size = 0.5) +  
  facet_wrap(~category2, ncol = 2, scales = "free_y") +
...
means_first_milestone_category <- startup_data %>%
  filter(category2 == "mobile") %>% # depending on which industry we want to go in 
...
However, there is no difference in age for funding
